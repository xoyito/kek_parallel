...
# document links that were scraped
...
# loop through links to get text
for link in links:
    ...
    # generate Q'eqchi' file name and write text to file
    ...
    with open("Scraped\\KEK_TRIPLE\\" + kek_filename + ".txt", "w", encoding="utf8") as outfile:
        outfile.write(kek_text)

    # generate English file name and write text to file
    ...
    with open("Scraped\\ENG_TRIPLE\\" + eng_filename + ".txt", "w", encoding="utf8") as outfile:
